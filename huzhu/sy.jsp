...
<script src="../layer.js"></script>
  <script>
    ...
    window.open ("in.jsp", "newwindow", "height=400, width=600, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no")
		   ...
		   <div Class='r1'>
               ...
               <div Class='r12'>
                    <div Class='r10' onclick="openwin()"> 
				     ...
				     <form method="post" action="ss.jsp"  Class='r13'>
				   	  
                       <input type="text" name="num" placeholder='搜索编号' > 
...
<p Class='r2'>
			 <a Class='r8' href='inupdate.jsp?num=<%=rs.getString("num")%>&sex=<%=rs.getString("sex")%>&tel=<%=rs.getString("tel")%>&id=<%=rs.getString("id")%>&idCard=<%=rs.getString("idCard")%>&num=<%=rs.getString("num")%>'>修改</a> 
