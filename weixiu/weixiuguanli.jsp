...
<script src="../layer.js"></script>
  <script>
    ...
    window.open ("weixiu_tianjia.jsp", "newwindow", "height=400, width=600, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no")
...
<%
	  ...
	  try
	  {
          ...
          ResultSet rs = sql.executeQuery("select * from weixiu ;");
		   int s=0;
		   %>
               ...
               <div Class='r12'>
                    <div Class='r10' onclick="openwin()"> 
				     ...
				     <form method="post" action="sousuo.jsp"  Class='r13'>
                       ...
                       <input type="text" name="id"  placeholder='按门牌号搜索' > 
...
<p Class='r2'>
			 ...
			 <a Class='r9' href='weixiu_shanchu.jsp?id=<%=rs.getString("home_num")%>'>删除</a>
			   </div>
